...
type DiscountWithTiers = Discount & { tiers: DiscountTier[], percentage: number | null };
...
export function EditDiscountForm({ discount: initialDiscount }: EditDiscountFormProps) {
    ...
    const [type, setType] = useState<DiscountType>(initialDiscount.type);
    ...
    const [percentage, setPercentage] = useState<number | undefined>(initialDiscount.percentage ?? undefined);
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        formData.set('id', initialDiscount.id);
        ...
        <form onSubmit={handleSubmit}>
            ...
            <Card className="max-w-3xl mx-auto">
                <CardHeader>
                    ...
                    <CardDescription>Update the type, rules, and tiers for this promotional discount.</CardDescription>
                </CardHeader>
                                ...
                                <div key={tier.id} className="p-4 border rounded-lg space-y-4 relative bg-muted/50">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input id={`percentage-${index}`} type="number" placeholder="e.g., 10" required value={Number(tier.percentage) || ''} onChange={e => handleTierChange(index, 'percentage', Number(e.target.value))} />
                                        </div>
                                    </div>
